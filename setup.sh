...
# List of packages:
packages=("git" "gimp" "keepass" "tmux" "zsh" "zsh-completions" "ripgrep" "rofi" "tldr" "falkon" "fcron" "openvpn" "alacritty" "btop" "flameshot" "powertop" "xautolock" "playerctl" "dex" "veracrypt" "libinput" "brightnessctl" "ffmpeg" "yubikey-manager-gui" "inetutils")
